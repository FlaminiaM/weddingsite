...
function RsvpForm({attendees, handleAddAttendee, isItalian}) {
  ...
  const subtitle = isItalian ? "Fateci sapere se ci sarete compilando individualmente il questionario sottostante." : "Let us know if you can come and enjoy our special day with us!";
